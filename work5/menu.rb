class Menu
  ...
  def create_train
    return if @created_route.size == 0
      ...
      puts 
      case type_train
      when 1 then @created_trains << PassengerTrain.new(num_train, @created_route[choosed_route_tr])
      when 2 then @created_trains << CargoTrain.new(num_train, @created_route[choosed_route_tr])
